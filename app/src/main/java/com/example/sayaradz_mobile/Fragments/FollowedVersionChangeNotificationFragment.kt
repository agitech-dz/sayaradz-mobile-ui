...
import com.example.sayaradz_mobile.databinding.FragmentFollowedVersionChangeNotificationBinding
...
class FollowedVersionChangeNotificationFragment : Fragment() {

    val args:FollowedVersionChangeNotificationFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        val binding: FragmentFollowedVersionChangeNotificationBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_followed_version_change_notification,
            container,
            false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        offerTotal.text = notification.body!!.verb
