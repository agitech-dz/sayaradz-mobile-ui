...
class InboxFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://www.sciencesetavenir.fr/assets/img/2018/09/06/cover-r4x3w1000-5b91612a81afc-section-hero-background.jpg"))
        notificationList.add(Notification("Offer", "Your Tesla Model 3 Car is Ready!","https://www.teslarati.com/wp-content/uploads/2019/06/tesla-model-s-refresh-concept.jpg"))
        notificationList.add(Notification("Offer", "Your Tesla Model 3 Car is Ready!","https://st.motortrend.com/uploads/sites/10/2015/11/2015-tesla-model-s-sedan-angular-front.png"))
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://img.autoplus.fr/news/2019/04/24/1537947/1200%7C800%7C1af8c7e95f9df8de31cbc146.jpg"))
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://cdn.motor1.com/images/mgl/OjmPo/s1/tesla-model-s-render.jpg"))
        notificationList.add(Notification("Offer", "Your Tesla Model 3 Car is Ready!","https://img.autoplus.fr/picture/tesla-motors/model-s/1503606/Tesla_Motors_Model_S_2016_44c4a-1200-800.jpg"))
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://www.forbes.fr/wp-content/uploads/2019/09/tesla-sans-cuir-740x370.jpg"))
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://www.protegez-vous.ca/var/protegez_vous/storage/images/_aliases/width_900px/medias/galerie-photo/tesla-model-3/1936/2715617-1-fre-CA/1936.jpg"))
        notificationList.add(Notification("Offer", "Your Tesla Model 3 Car is Ready!","https://images.sudouest.fr/2017/04/17/58f4872c66a4bdfc5a1d122c/widescreen/1000x500/la-derniere-version-de-la-tesla-propose-une-face-avant-plus-elegante.jpg"))
        notificationList.add(Notification("Offer", "Your Tesla Model 3 Car is Ready!","https://www.largus.fr/images/images/tesla-model-s_1.jpg?width=612&quality=80"))
        notificationList.add(Notification("Command", "Your Tesla Model 3 Car is Ready!","https://cdn.shopify.com/s/files/1/0043/8471/8938/products/155674392269619844_812x.jpg?v=1556743983"))
