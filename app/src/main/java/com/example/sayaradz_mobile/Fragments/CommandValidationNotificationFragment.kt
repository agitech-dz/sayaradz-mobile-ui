...
import com.example.sayaradz_mobile.databinding.FragmentCommandValidationNotificationBinding
...
class CommandValidationNotificationFragment : Fragment() {

    val args:CommandValidationNotificationFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        val binding: FragmentCommandValidationNotificationBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_command_validation_notification,
            container,
            false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        actorName.text = notification.body!!.verb
